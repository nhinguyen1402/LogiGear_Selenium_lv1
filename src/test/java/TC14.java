...
import org.railway.stationenum.SeatType;
...
public class TC14 extends BaseTest {
    ...
    public void testcase014() {
        ...
        String departStationValue= Station.SAIGON.getValue();
        ...
        String arriveStationValue= Station.NHATRANG.getValue();
        ...
        softAssert.assertEquals(bookTicketPage.getBookTicketSuccessMsg(), "Ticket Booked Successfully!", "Success message does not display as expected!");
        ...
        softAssert.assertEquals(bookTicketPage.getDepartDateText(), date, "Depart Date is not same");
        softAssert.assertEquals(bookTicketPage.getDepartStationText(), departStationValue, "Depart Station is not same");
        softAssert.assertEquals(bookTicketPage.getArriveStationText(), arriveStationValue, "Arrive Station is not same");
        softAssert.assertEquals(bookTicketPage.getSeatTypeText(), seatType, "Seat Type is not same");
        softAssert.assertEquals(bookTicketPage.getAmountText(), ticketAmount, "Amount is not same");
